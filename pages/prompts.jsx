...
export default function Home({ showToast }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-8">
            ...
            <div className="flex items-center space-x-4">
              <Link
                href="/"
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg font-semibold hover:from-blue-600 hover:to-purple-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                ← Back to Portfolio
              </Link>
        ...
        <div className="mb-8">
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 pl-12 pr-4 text-gray-100 bg-gray-800/50 border border-gray-600/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 backdrop-blur-sm placeholder-gray-400 transition-all duration-300"
            />
      ...
      {/* Portfolio Section */}
      <section className="py-20 bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                {['Next.js', 'PostgreSQL', 'Neon', 'TailwindCSS', 'bcrypt', 'React'].map((tech) => (
                  <span
                    key={tech}
                    className="px-4 py-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 text-blue-300 rounded-full text-sm font-medium border border-blue-500/30 hover:border-blue-400/50 transition-all duration-300"
                  >
                    {tech}
                  </span>
                ))}
              ...
              <div className="flex gap-4">
                <Link
                  href="/"
                  className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-xl font-semibold hover:from-blue-600 hover:to-purple-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                >
                  View Full Portfolio
                </Link>
              </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-gray-700/50">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 mb-6 text-lg">Full Stack Developer & AI Enthusiast</p>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between items-center py-2 px-4 bg-gray-700/50 rounded-lg">
